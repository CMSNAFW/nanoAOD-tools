...
class MuonSF(Module):
    ...
    def analyze(self, event):
        ...
        return True
'''
MUO_repo = "/cvmfs/cms-griddata.cern.ch/cat/metadata/MUO/"
mu_idisosf_2022 = MuonSF(f"{MUO_repo}22CDSep23-Summer22-NanoAODv12/latest/muon_Z.json.gz")
mu_idisosf_2022.addCorrection("NUM_TightID_DEN_TrackerMuons", 'nominal', "Muon_IDSF")
mu_idisosf_2022.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systup', "Muon_IDSFUp")
mu_idisosf_2022.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systdown', "Muon_IDSFDown")
mu_idisosf_2022EE = MuonSF(f"{MUO_repo}22EFGSep23-Summer22EE-NanoAODv12/latest/muon_Z.json.gz")
mu_idisosf_2022EE.addCorrection("NUM_TightID_DEN_TrackerMuons", 'nominal', "Muon_IDSF")
mu_idisosf_2022EE.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systup', "Muon_IDSFUp")
mu_idisosf_2022EE.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systdown', "Muon_IDSFDown")
mu_idisosf_2023 = MuonSF(f"{MUO_repo}23CSep23-Summer23-NanoAODv12/latest/muon_Z.json.gz")
mu_idisosf_2023.addCorrection("NUM_TightID_DEN_TrackerMuons", 'nominal', "Muon_IDSF")
mu_idisosf_2023.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systup', "Muon_IDSFUp")
mu_idisosf_2023.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systdown', "Muon_IDSFDown")
mu_idisosf_2023BP = MuonSF(f"{MUO_repo}23DSep23-Summer23BPix-NanoAODv12/latest/muon_Z.json.gz")
mu_idisosf_2023BP.addCorrection("NUM_TightID_DEN_TrackerMuons", 'nominal', "Muon_IDSF")
mu_idisosf_2023BP.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systup', "Muon_IDSFUp")
mu_idisosf_2023BP.addCorrection("NUM_TightID_DEN_TrackerMuons", 'systdown', "Muon_IDSFDown")
mu_idisosf_2024 = MuonSF(f"{MUO_repo}24CDEReprocessingFGHIPrompt-Summer24-NanoAODv15/latest/muon_Z.json.gz")
