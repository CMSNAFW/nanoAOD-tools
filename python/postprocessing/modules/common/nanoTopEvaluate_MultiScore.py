...
if not os.getenv("CMSSW_BASE") is None:
    ...
    path_to_model_folder    = "%s/NanoAODTools/python/postprocessing/data/dict_tresholds/" % NanoAODFolder
    folder_model_antimo     = "%s/NanoAODTools/python/postprocessing/data/dict_tresholds/" % NanoAODFolder
