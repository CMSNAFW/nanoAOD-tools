...
class btagSFProducer(Module):
    ...
    def __init__(
            self, era, algo='deepcsv', selectedWPs=['shape_corr'],
...
btagSF_2016 = lambda: btagSFProducer("Legacy2016")
btagSF_2017 = lambda: btagSFProducer("UL2017")
btagSF_2018 = lambda: btagSFProducer("UL2018")
