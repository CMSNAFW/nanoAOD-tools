...
inpfiles = {#"muon_16":["DataMu_2016", "DataEle_2016", "DataPh_2016", "TT_dilep_2016"],
            ...
            "muonjet_17":["DataMu_2017","DataEle_2017","DataPh_2017","DataHT_2017","TT_dilep_2017"],#["DataMu_2017", "DataEle_2017", "DataPh_2017", "TT_dilep_2017","DataHT_2017","TT_Mtt_2017","ST_2017","QCD_2017","WJets_2017"],
            "electronjet_17":["DataMu_2017","DataEle_2017","DataPh_2017","DataHT_2017","TT_dilep_2017"],#["DataMu_2017", "DataEle_2017", "DataPh_2017", "TT_dilep_2017","DataHT_2017","TT_Mtt_2017","ST_2017","QCD_2017","WJets_2017"],
            #"jet_17":["DataMu_2017","DataEle_2017","DataPh_2017","DataHT_2017","TT_Mtt_2017","QCD_2017","WJets_2017","ST_2017"],
            "muonjet_18":["DataMu_2018","DataEle_2018","TT_dilep_2018"],#,"DataHT_2018"]#["DataMu_2018",  "DataEle_2018", "TT_dilep_2018","DataHT_2018","TT_Mtt_2018","ST_2018","QCD_2018","WJets_2018"],
            "electronjet_18":["DataMu_2018", "DataEle_2018", "TT_dilep_2018"],#,"DataHT_2018","TT_Mtt_2018","ST_2018","QCD_2018","WJets_2018"],
...
#edges_mux = array.array('f', [-2.5,-2.0,-1.566,-1.444,-0.8,0.0,0.8,1.444,1.566,2.0,2.5])
edges_mux = array.array('f', [0.0,0.8,1.444,1.566,2.0,2.5])
#edges_mux = array.array('f', [-2.5,-2.1,-1.2,-0.9,0.0,0.9,1.2,2.1,2.5])
...
for inpfile in inpfiles[period]:
    ...
    if 'muon' in period:
        if 'Data' in infile.GetName():
            tree.Project("HLT_TightLep_num", "muon_pt:abs(muon_eta)", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")
            ...
            tree.Project("h1D_HLT_TightLep_num", "muon_pt", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")
            ...
            tree.Project("h1D_HLT_Top_num", "muon_pt", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")
            ...
            tree.Project("HLT_Top_num", "muon_pt:abs(muon_eta)", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")                           
            ...
            #tree.Project("HLT_CR_num", "muon_pt:abs(muon_eta)", "PFSF*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0))*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0])")
            #tree.Project("HLT_CR_den", "muon_pt:abs(muon_eta)", "PFSF*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])")

        elif "TT_dilep" in infile.GetName():
            tree.Project("HLT_TightLep_num", "muon_pt:abs(muon_eta)", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")
            ...
            tree.Project("h1D_HLT_TightLep_num", "muon_pt", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")
            ...
            tree.Project("h1D_HLT_Top_num", "muon_pt", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")
            ...
            tree.Project("HLT_Top_num", "muon_pt:abs(muon_eta)", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0] || HLT_PFJet_nominal[0])")
        ...
        #else:
        #    tree.Project("HLT_CR_num", "muon_pt:abs(muon_eta)", "PFSF*electron_SF*muon_SF*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0))*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0])")
        #    tree.Project("HLT_CR_den", "muon_pt:abs(muon_eta)", "PFSF*electron_SF*muon_SF*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==0 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])")
            
        #print h_HLT_TightLep_num.Integral()
    elif 'electron' in period:
        if 'Data' in infile.GetName():
            tree.Project("HLT_TightLep_num", "electron_pt:abs(electron_eta)", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>=-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")
            ...
            tree.Project("h1D_HLT_TightLep_num", "electron_pt", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>=-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")
            ...
            tree.Project("h1D_HLT_Top_num", "electron_pt", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")
            ...
            tree.Project("HLT_Top_num", "electron_pt:abs(electron_eta)", "w_nominal*PFSF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")
            ...
            #tree.Project("HLT_CR_num", "electron_pt:electron_eta", "PFSF*w_Dcount*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0])") 
            #tree.Project("HLT_CR_den", "electron_pt:electron_eta", "PFSF*w_Dcount*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0)*(HLT_Muon_nominal[0])")

        elif "TT_dilep" in infile.GetName():
            tree.Project("HLT_TightLep_num", "electron_pt:abs(electron_eta)", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>=-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")                     
            ...
            tree.Project("h1D_HLT_TightLep_num", "electron_pt", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>=-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")
            ...
            tree.Project("h1D_HLT_Top_num", "electron_pt", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")
            ...
            tree.Project("HLT_Top_num", "electron_pt:abs(electron_eta)", "PFSF*electron_SF*muon_SF*puSF*isdileptonic*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]>-1)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0] || HLT_PFJet_nominal[0])*(HLT_Muon_nominal[0])")
        ...
        #else:
        #    tree.Project("HLT_CR_num", "electron_pt:electron_eta", "PFSF*electron_SF*muon_SF*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0)*(HLT_Electron_nominal[0] || HLT_Photon_nominal[0])*(HLT_Muon_nominal[0])")
        #    tree.Project("HLT_CR_den", "electron_pt:electron_eta", "PFSF*electron_SF*muon_SF*puSF*(isdileptonic[0]==0)*w_pt*(isPromptEle[0]==1 && top_region_nominal[0]==-1 && AK8_region_nominal[0]==0)*(HLT_Muon_nominal[0])")
