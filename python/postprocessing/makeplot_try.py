...
def makestack(lep_, reg_, variabile_, samples_, cut_tag_, syst_, lumi):
     ...
     if("top_region_nominal==1" in opt.cut):
...
if(opt.dat!= 'all'):
     ...
     dataset_dict = {
          ...
          '2018': [ST_2018,WJets_2018, QCD_2018,Tprime_tHq_600LH_2018,Tprime_tHq_700LH_2018,Tprime_tHq_800LH_2018,Tprime_tHq_900LH_2018,Tprime_tHq_1000LH_2018,Tprime_tHq_1100LH_2018,Tprime_tHq_1200LH_2018,Tprime_tHq_1300LH_2018,Tprime_tHq_1400LH_2018,Tprime_tHq_1600LH_2018,Tprime_tHq_1700LH_2018,Tprime_tHq_1800LH_2018,DataMu_2018,DataEle_2018,DataHT_2018,Tprime_tHq_1500LH_2018,TT_Mtt_2018],
          '2018_noQCD': [DataMuA_2018, WJets_2018, TT_Mtt_2018],
     }
...
for year in years:
     for lep in leptons:
          ...
          #variables.append(variabile('Top_M_nominal','Best Top M',wzero+'*('+cut+')',  100, 0, 600))
          #variables.append(variabile('Top_pt_nominal','Best Top Pt',wzero+'*('+cut+')',  100, 0, 600))
          ...
          variables.append(variabile('Tprime_M_nominal','Best T\' M',wzero+'*('+cut+')',  28, 600, 2000))
          variables.append(variabile('Top_TvsOth_nominal','Best Top ScoreVsOth',wzero+'*('+cut+')',  20, 0, 1))
          variables.append(variabile('FatJet_M_nominal','FatJet M',wzero+'*('+cut+')',  30, 0, 300))
          
          """
          variables.append(variabile('MET_nominal','Met',wzero+'*('+cut+')', 20, 25, 225))
          variables.append(variabile('FatJet_Xbb_nominal','FatJet score vs QCD',wzero+'*('+cut+')',  20, 0, 1))
          variables.append(variabile('FatJet_M_nominal','FatJet M',wzero+'*('+cut+')',  20, 0, 200))
          variables.append(variabile('Jet_btag_nominal','Jet score vs QCD',wzero+'*('+cut+')',  20, 0, 1))
          variables.append(variabile('Lep_Id_nominal','Lep Id',wzero+'*('+cut+')',  5, 0, 5))
          variables.append(variabile('N_bjet_nominal','N bJet',wzero+'*('+cut+')',  6, 0, 6))
          
          variables.append(variabile('dR_bjet_AK8_nominal','dR(AK8,b-oth)',wzero+'*('+cut+')',  50, 1, 10))
          
          variables.append(variabile('M_bjet_AK8_nominal','M(AK8,b-oth)',wzero+'*('+cut+')',  50, 0, 300))
          variables.append(variabile('N_top_nominal','N Top',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_AK8_nominal','N AK8',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_jet_nominal','N Jet',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('dR_jet_AK8_nominal','dR(AK8,b-top)',wzero+'*('+cut+')',  50, 0, 1))
          variables.append(variabile('Tprime_dR_nominal','dR(AK8,top)',wzero+'*('+cut+')',  50, 1, 10))
          variables.append(variabile('N_muTop_nominal','N Muon Top',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_muLoose_nominal','N Muon Loose',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_muVeryLoose_nominal','N Muon Very Loose',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_elTop_nominal','N Ele Top',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_elLoose_nominal','N Ele Loose',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_elVeryLoose_nominal','N Ele Very Loose',wzero+'*('+cut+')',  6, 0, 6))

          variables.append(variabile('N_elTop_nominal+N_muTop_nominal','N Lep Top',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_elLoose_nominal+N_muLoose_nominal','N Lep Loose',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('N_elVeryLoose_nominal+N_muVeryLoose_nominal','N Lep Very Loose',wzero+'*('+cut+')',  6, 0, 6))
          
          variables.append(variabile('Top_LepIdx_nominal','Lep Idx',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('Top_JetIdx_nominal','Jet Idx',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('SecTop_LepIdx_nominal','Sec Lep Idx',wzero+'*('+cut+')',  6, 0, 6))
          variables.append(variabile('SecTop_JetIdx_nominal','Sec Jet Idx',wzero+'*('+cut+')',  6, 0, 6))
          
          variables.append(variabile('SecTop_JetIdx_nominal==Top_JetIdx_nominal && N_top_nominal>1','Jet1=Jet2',wzero+'*('+cut+')',  2, 0, 2)) 
          variables.append(variabile('SecTop_LepIdx_nominal==Top_LepIdx_nominal && Top_flavour_nominal==SecTop_flavour_nominal && N_top_nominal>1','Lep1=Lep2',wzero+'*('+cut+')',  2, 0, 2)) 
          """
               ...
               if(opt.plot):
                    for syst in systematics:
                         if "TT" in sample.label:
                              variables.append(variabile('FatJet_M_nominal','FatJet M Low Mass',wzero+'*('+cut+' && FatJet_M_nominal<=20)',  30, 0, 300))
                              cut_tag_coll.append("Low_mass_jet")
                              variables.append(variabile('FatJet_M_nominal','FatJet M 1b',wzero+'*('+cut+' && FatJet_M_nominal>20 && FatJet_MC_nominal==1)',  30, 0, 300))
                              cut_tag_coll.append("1bjet")
                              variables.append(variabile('FatJet_M_nominal','FatJet M 1b+1l',wzero+'*('+cut+'&& FatJet_M_nominal>20 && FatJet_MC_nominal==11)',  30, 0, 300))
                              cut_tag_coll.append("1bjet_1lep")
                              variables.append(variabile('FatJet_M_nominal','FatJet M 1b+1q',wzero+'*('+cut+'&& FatJet_M_nominal>20 && FatJet_MC_nominal==101)',  30, 0, 300))
                              cut_tag_coll.append("1bjet_1q")
                              variables.append(variabile('FatJet_M_nominal','FatJet M 1b+2q',wzero+'*('+cut+'&& FatJet_M_nominal>20 && FatJet_MC_nominal==201)',  30, 0, 300))
                              cut_tag_coll.append("1bjet_2q")
                              variables.append(variabile('FatJet_M_nominal','FatJet M 2q',wzero+'*('+cut+'&& FatJet_M_nominal>20 && FatJet_MC_nominal==200)',  30, 0, 300))
                              cut_tag_coll.append("2q")
                              variables.append(variabile('Top_TvsOth_nominal','Best Top ScoreVsOth True',wzero+'*('+cut+' && Top_MC_nominal==1)',  20, 0, 1))
                              cut_tag_coll.append("top_true")
                              variables.append(variabile('Top_TvsOth_nominal','Best Top ScoreVsOth 0prompt',wzero+'*('+cut+' && Top_MC_nominal==0)',  20, 0, 1))
                              cut_tag_coll.append("top0prompt")
                              variables.append(variabile('Top_TvsOth_nominal','Best Top ScoreVsOth 1prompt',wzero+'*('+cut+' && Top_MC_nominal>1)',  20, 0, 1))
                              cut_tag_coll.append("top1prompt")
                         print(cut_tag_coll)
