...
def rooPart1():
	...
	#x Axis variable
	mass = ROOT.RooRealVar("mass","mass plot",0,1600,"GeV")
	...
	Zp_400 = f.Get("ttbar_mass_ZPrime400")
	...
	#signal
	signal = ROOT.RooFormulaVar("total_events", "mu*nZp_400", ROOT.RooArgList(mu,nZp_400))
